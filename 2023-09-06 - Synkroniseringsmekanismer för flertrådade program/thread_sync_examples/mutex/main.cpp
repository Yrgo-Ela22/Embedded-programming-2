/********************************************************************************
 * @brief Example program where a mutex ist used for thread synchronization.
 ********************************************************************************/
#include <iostream>
#include <thread>
#include <mutex>
...
std::mutex mutex{}; /* Mutex used for synchronizing usage of the terminal. */
...
/********************************************************************************
 * @brief Runs thread by printing the ID with specified frequency. A mutex is
 *        used to lock access to the terminal when the calling thread is to print.
 *        A 10 ms delay is implemented before unlocking the mutex to make
